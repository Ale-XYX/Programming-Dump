        ...
        for event in pygame.event.get():
            ...
            # Keymap
                ...
                if event.key == pygame.K_RCTRL and not PLAYER2.toggle:
                    d.GAME_DICT[g.P1CHAR.upper()]['ABILITY'](BULLETS2, ALL_SPRITES, PLAYER2.rect.center, pygame.math.Vector2(PLAYER2.fire_direction), m.MEDIA['bigbullettest'])
                    m.MEDIA['shoot_sound'].play()
                if event.key == pygame.K_g and not PLAYER1.toggle:
                    d.GAME_DICT[g.P2CHAR.upper()]['ABILITY'](BULLETS1, ALL_SPRITES, PLAYER1.rect.center, pygame.math.Vector2(PLAYER1.fire_direction), m.MEDIA['bigbullettest'])
                    m.MEDIA['shoot_sound'].play()
